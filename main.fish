...
python main.py --type=encrypt --rotate --invert -i lena_orig.jpg -o lena_encrypted.jpg
...
python main.py --type=decrypt --rotate --invert -i lena_encrypted.jpg -o lena_decrypted.jpg
